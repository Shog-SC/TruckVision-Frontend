// TruckVision V4 - app.js
// -----------------------
// - Dashboard camion (rpm, gear, fuel %, damages, régulateur, etc.)
// - ADR détecté à partir du nom de la cargaison (heuristique)
// - Reste identique : villes, stations, camions, route, liste joueurs.
...
function updateSidebar(players) {
  ...
  if (me) {
    ...
    const cruiseSpeed = truck.cruiseControlSpeed ? Math.round(truck.cruiseControlSpeed * 3.6) : 0; // m/s -> km/h approx.
